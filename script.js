...
"https://script.google.com/macros/s/AKfycbz7I5MEFQbX1Xp5cqwBgE__hefUlrCUQcRZuOe8B6gU9c-8OyggInjMS4tCsFBOtmcd/exec";
/* ===========================
   Helpers & title
=========================== */
...
function lsInit(){
  gbList.innerHTML = '';
  lsLoad().sort((a,b)=>(a.timestamp||0)-(b.timestamp||0))
          .forEach(e => renderOne(e, { prepend:false }));
}
